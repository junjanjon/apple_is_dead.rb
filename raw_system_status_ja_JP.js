      ...
      "events": [
        {
          ...
          "datePosted": "2019/07/07 00:59 JST",
          "startDate": "2019/07/06 21:00 JST",
          "endDate": "2019/07/07 01:00 JST",
          "affectedServices": null,
          "eventStatus": "completed",
          "message": "JR東日本 のカード利用者は、Apple Payにおいて一部の機能が使えない状況が発生しておりました。"
        },
        {
          "usersAffected": "一部のユーザに影響しました",
      ...
      "events": [
        {
          ...
          "eventStatus": "resolved",
          "message": "友達やデバイスの位置検索、登録済みデバイスのリスト表示、デバイスでのサウンド再生、デバイスのリモートワイプ、デバイスの紛失モード設定ができなかった可能性があります。"
        }
      ],
      "redirectUrl": null,
